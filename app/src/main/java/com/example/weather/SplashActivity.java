...
public class SplashActivity extends AwesomeSplash {
    ...
    public void initSplash(ConfigSplash configSplash) {
        ...
        configSplash.setBackgroundColor(R.color.grey); //any color you want form colors.xml
        ...
        //Customize Logo
        configSplash.setLogoSplash(R.drawable.w); //or any other drawable
        ...
        configSplash.setTitleTextColor(R.color.grey);
